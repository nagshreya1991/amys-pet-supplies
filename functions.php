...
function twentyten_widgets_init() {
	...
	// Area 1, located at the top of the sidebar.
	register_sidebar( array(
		'name' => __( 'Shop Category', 'twentyten' ),
		'id' => 'Shop-Category',
		'description' => __( 'Add widgets here to appear in your sidebar.', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
...
/*?>function get_vimeo_data_from_id( $video_id, $data ) {
	$request = wp_remote_get( 'https://vimeo.com/api/oembed.json?url=https://player.vimeo.com/video/' . $video_id );
...
<?php add_filter('woocommerce_enable_order_notes_field', '__return_false');
...
function order_completed( $order_id ) {
	...
	$to_email = 'shreya@properbounce.com';
    $headers = 'From: Your Name <chakishreya@gmail.com>' . "\r\n";
